import '/admin/updated_success/updated_success_widget.dart';
                                ...
                                builder: (context) => SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          FFLocalizations.of(context).getText(
                                        '1ct1wl8l' /* Phone Number */,
                                      ),
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'zvm26sjq' /* Phone Number */,
                                      ),
