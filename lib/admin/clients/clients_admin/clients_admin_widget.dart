import '/admin/clients/add_client/add_client_widget.dart';
...
class ClientsAdminWidget extends StatefulWidget {
  const ClientsAdminWidget({super.key});

  @override
  State<ClientsAdminWidget> createState() => _ClientsAdminWidgetState();
}
                                                      ...
                                                      children: [
                                                        StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            final textGouverneratRecord =
                                                                snapshot.data!;

                                                            return Text(
                                                              textGouverneratRecord
                                                                  .name,
